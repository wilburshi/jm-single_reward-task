...
struct App : public om::App {
  ...
  std::string experiment_date{ "20250128" };
  ...
  int whogetjuice{ 0 }; // when task type is 3, both animnals have to pull, but only one get juice. this variable indicate which animal get the juice (this is the pump id; 0 or 1)
